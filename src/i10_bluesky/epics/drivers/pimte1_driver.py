...
from ophyd_async.epics.areadetector.utils import ad_rw, ad_r
from ophyd_async.epics.signal import epics_signal_w
...
class Pimte1Driver(ADBase):
    def __init__(self, prefix: str) -> None:
        ...
        self.setTemperture = epics_signal_w(float, prefix + "SetTemperature")
        self.getTemperture = ad_r(float, prefix + "MeasuredTemperature")
